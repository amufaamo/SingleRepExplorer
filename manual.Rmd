...
```bash
docker run --rm -p 3838:3838 amufaamo/singlerepexplorer:v1.1.12
```

This command will automatically:

1.  Download (pull) the `amufaamo/singlerepexplorer:v1.1.12` image from Docker Hub, if you don't have it.
