...
# SiCR Docker ビルド・実行スクリプト

echo "=== SiCR Docker Setup Script ==="
...
echo "==================================================================="
echo "SiCR Shiny App should be starting up..."
echo "Access URL: http://localhost:3838/sicr/"
echo "To view logs: docker-compose logs -f sicr-app"
