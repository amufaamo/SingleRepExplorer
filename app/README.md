# SingleRepExplorer: Web Application for Single Cell Repertoire Analysis
...
SingleRepExplorer is a comprehensive workbench that can be used by all biologists for analysis. SingleRepExplorer significantly reduces the time and effort required to analyze and interpret information in single-cell immune-profiling.
...
SingleRepExplorer uses following libraries, so please install using this command
```R
...
```
### 3.3 Download SingleRepExplorer scripts, and unzip it.
Click here https://github.com/Masakazu-Ishikawa137/SingleRepExplorer/archive/refs/heads/main.zip


## 4. How to use
### 4.1 Starting SingleRepExplorer
1. Open the 'app.R' file in the downloaded folder using R studio.
2. Press 'Run App' button in R studio. SingleRepExplorer will be launched.
...
After running cellranger, please upload these cellranger output files into SingleRepExplorer.
